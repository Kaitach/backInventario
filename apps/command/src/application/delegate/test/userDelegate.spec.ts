import { of } from 'rxjs';
import {CommandBus,  UserDomainService, IUserEntity, BranchDomainService, IBranchEntiy } from '../../../../../shared';
...
describe('userDelegate', () => {
  ...
  beforeEach(() => {
    ...
    UserDelegate = new userDelegate(userServiceMock, commandBusMock, branchServiceMock);
  });
